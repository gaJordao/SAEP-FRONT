...
function GerenciarTarefas() {
  return (
      <main>
          ...
          <div className="flex flex-wrap items-center justify-center gap-[2rem] mt-[5rem] h-auto w-[100%]">
    
                  <div className="flex flex-col items-center justify-center bg-slate-600 w-[90%] sm:w-[35rem] h-[20rem] rounded-3xl">
                      <h1 className="mb-[2rem] text-[2rem] text-white">Cadastro de Usuários</h1>
                      <div className="flex flex-col items-start ml-[3rem] w-[100%] gap-[2rem]">
